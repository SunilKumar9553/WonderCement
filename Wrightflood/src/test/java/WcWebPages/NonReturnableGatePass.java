...
public class NonReturnableGatePass {
	...
	public static By approveGatePassIdInput = By.xpath("//input[@placeholder='Gate Pass ID']");
	...
	public void filePathValue() {
		...
		String path = "C:\\Users\\Sunil\\Downloads\\NonReturnableGatePass.xlsx";

	}

	public void createNonReturnableGatePass() throws Exception {
		path = "C:\\Users\\Sunil\\Downloads\\NonReturnableGatePass.xlsx";
		...
		for (int i = 1; i < headersSize; i++) {
			...
			webActions.clearAndSendKeys(inputField, "Non-Returnable gate pass");
			robot.keyPress(KeyEvent.VK_ENTER);
			robot.keyRelease(KeyEvent.VK_ENTER);
			...
			if (isTrue) {
				...
				webActions.clearAndSendKeys(gatePassTypeInput, "Non-Returnable gate");
			...
			Thread.sleep(3000);
			webActions.clearAndSendKeys(approveGatePassIdInput, gatePassNumber);
			Thread.sleep(2000);
			robot.keyPress(KeyEvent.VK_ENTER);
			robot.keyRelease(KeyEvent.VK_ENTER);
			Thread.sleep(2000);
	...
	private void storeUserSignIn(int i) throws Exception{
